...
import '../../app/common/form/TextInput';
    ...
    render() {
        ...
        return (
            <form onSubmit={this.props.handleSubmit(this.onFormSubmit)}>
                ...
                <Field name="trailname" component={TextInput} type="text" placeholder="name of trail" /> <br />
                <label for="traildesc">Trail description</label> <br />
                <Field name="traildesc" component={TextInput} type="text" placeholder="description of trail" /> <br />
                <label for="traillocation">location</label> <br />
                <Field name="traillocation" component={TextInput} type="text" placeholder="location of trail" /> <br />
